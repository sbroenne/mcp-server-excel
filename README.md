...
**MCP Server for Excel** enables AI assistants (GitHub Copilot, Claude, ChatGPT) to automate Excel through natural language commands. Automate Power Query, DAX measures, VBA macros, PivotTables, Charts, formatting, and data transformations (27 tools with 249 operations).
...
**27 specialized tools with 249 operations:**
...
📚 **[Complete Feature Reference →](FEATURES.md)** - Detailed documentation of all 249 operations
