...
/// <summary>
/// Simple integration tests for SetupCommands using batch pattern
/// </summary>
...
public class SetupCommandsSimpleTests : IDisposable
{
    ...
    public SetupCommandsSimpleTests()
    {
        _testDir = Path.Combine(Path.GetTempPath(), $"ExcelMcp_SetupSimple_{Guid.NewGuid():N}");
    ...
    public async Task CheckVbaTrust_ReturnsResult()
    {
        ...
        // Result can be trusted or not - both are valid
