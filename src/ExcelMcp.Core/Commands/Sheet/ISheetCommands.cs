...
public interface ISheetCommands
{
    ...
    /// <summary>
    /// Sets the tab color for a worksheet using RGB values (0-255 each) (filePath-based API).
    /// Excel uses BGR format internally, conversion is handled automatically.
    /// </summary>
    ...
    /// <summary>
    /// Clears the tab color for a worksheet (resets to default) (filePath-based API)
    /// </summary>
    ...
    /// <summary>
    /// Hides a worksheet (user can unhide via Excel UI) (filePath-based API).
    /// Convenience method equivalent to SetVisibilityAsync(..., SheetVisibility.Hidden)
    /// </summary>
    ...
    /// <summary>
    /// Very hides a worksheet (requires code to unhide, for protection) (filePath-based API).
    /// Convenience method equivalent to SetVisibilityAsync(..., SheetVisibility.VeryHidden)
    /// </summary>
