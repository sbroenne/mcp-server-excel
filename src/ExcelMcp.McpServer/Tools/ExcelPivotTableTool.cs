...
public static partial class ExcelPivotTableTool
{
    ...
    public static async Task<string> ExcelPivotTable(
        [Description("Action to perform. Actions: list, get, create-from-range, create-from-table, create-from-datamodel, delete, refresh, list-fields, add-row-field, add-column-field, add-value-field, add-filter-field, remove-field, set-field-function, set-field-name, set-field-format, get-data, set-field-filter, sort-field")]
