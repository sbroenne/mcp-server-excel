...
- **`excel-mcp`** — MCP Server with 27 tools (249 operations) for conversational AI (Claude Desktop, Copilot chat)
...
Provides the full MCP Server with 27 tools (249 operations) for conversational AI:
