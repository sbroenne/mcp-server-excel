...
2. Resolves and installs the latest GitHub Actions runner release.
3. Registers labels `self-hosted`, `Windows`, `X64`, and `excel`.
4. Installs the runner as an automatic Windows service under `azureuser`.
