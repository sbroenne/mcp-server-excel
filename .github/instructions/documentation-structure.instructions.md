...
- Advertised counts are generated by `scripts\check-doc-counts.ps1 -Update` in
  the release workflow, not counted from tool files or CLI folders. Internal CLI
  diagnostics are excluded from the shared advertised surface.
